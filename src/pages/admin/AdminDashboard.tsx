...
export default function AdminDashboard() {
  ...
  const [tab, setTab] = useState<'dashboard'|'products'|'categories'|'navigation'|'discounts'|'site'|'orders'|'newsletter'|'inbox'|'reviews'|'testimonials'|'gallery'|'customers'|'analytics'|'settings'|'inventory'>('dashboard');
